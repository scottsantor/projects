# linear-jira-sync - Agent Instructions

This file provides instructions for AI coding agents working on this React project.

## Project Context

- **App Name**: linear-jira-sync
- **App ID**: linear-jira-sync
- **Brand**: block
- **Type**: ui
- **Framework**: React + Vite + TypeScript
- **Runtime**: cloudflare-worker
- **Database**: true
- **Deploy Command**: `appkit deploy linear-jira-sync ./build`
...
3. Open `http://localhost:5173/apps/linear-jira-sync`
...
```bash
appkit deploy linear-jira-sync ./build
```
